      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-gray-300 text-[14px] leading-relaxed max-w-sm mt-3">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-4 mt-2">
              {/* LinkedIn */}
              <a href="#" className="w-8 h-8 rounded border border-[#a855f7]/40 flex items-center justify-center text-[#a855f7] hover:bg-[#a855f7] hover:text-white transition-colors">
