...
import heroImage from "@/core/assets/day 3.jpeg";

export const HeroSectionJour3 = () => {
    ...
    <section className="relative min-h-[70vh] flex flex-col pb-16 bg-summit-dark overflow-hidden">
      ...
      <Container className="relative z-20 flex-1 flex flex-col justify-center w-full pt-32 pb-0">
        <div className="text-white max-w-4xl">
          ...
          <h1
            style={{ color: "#8B0B0B" }}
            className="text-3xl sm:text-4xl md:text-[4.5rem] font-black mb-4 leading-[1.1] md:leading-[1.05] tracking-tight"
          >
            Connexions
          </h1>
          ...
          >
            Rejoignez-nous pour la clôture spectaculaire de l'événement et
            découvrez toutes les opportunités qui s'offrent à vous.
          </p>
